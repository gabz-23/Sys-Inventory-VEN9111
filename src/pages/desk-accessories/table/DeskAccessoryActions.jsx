...
export const DeskAccessoryActions = ({ deskAccessory }) => {
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52">
                ...
                <DropdownMenuItem
                    ...
                    onClick={() => openDetailsDialog(deskAccessory)}
                >
                    <Eye />
                ...
                {!isViewer && (
                    <>
                        <DropdownMenuItem className="cursor-pointer flex items-center" onClick={() => openEditDialog(deskAccessory)}>
                            <Pencil />
                        ...
                        <DropdownMenuItem
                            ...
                            onClick={() => openDeleteDialog(deskAccessory)}
                        >
