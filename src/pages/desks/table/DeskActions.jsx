    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52">
                ...
                <DropdownMenuItem className="cursor-pointer flex items-center" onClick={() => openDetailsDialog(desk)}>
                    <Eye />
                ...
                {!isViewer && (
                    <>
                        <DropdownMenuItem className="cursor-pointer flex items-center" onClick={() => openEditDialog(desk)}>
                            <Pencil />
