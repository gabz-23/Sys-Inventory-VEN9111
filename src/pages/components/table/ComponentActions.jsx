...
export const ComponentActions = ({ component }) => {
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52">
                ...
                <DropdownMenuItem
                    ...
                    onClick={() => openDetailsDialog(component)}
                >
                    <Eye />
                ...
                {!isViewer && (
                    <>
                        <DropdownMenuItem className="cursor-pointer flex items-center" onClick={() => openEditDialog(component)}>
                            <Pencil />
